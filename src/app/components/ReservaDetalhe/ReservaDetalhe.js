...
export default function ReservaDetalhe() {
    ...
    // Carrega a reserva selecionada e guarda os detalhes no estado
    useEffect(() => {
        if (!id) return
    ...
    return <div key={id} className="group" style={{ display: 'flex', flexDirection: 'column', }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', padding: '8px' }}>
            ...
            <p className="mt-1 text-lg font-medium text-gray-900">Nome do quarto:</p>
            <a href={`/quartos/${quarto.id}/detalhes`}
