      ...
      {context.utilizador && context.utilizador.role === 'Gerentes' &&
        <>
          <div style={{ display: 'flex', justifyContent: 'flex-end', padding: '20px 0px' }}>
            <a href="/criar-utilizador" className='flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500'>Criar Utilizadores</a>
          </div>
          <div className="">
            <ListaUtilizadores />
          </div>
